...
export const submenuItems = {
  ...
  'My Entries': [['My Vouchers', '/my-vouchers'], ['My Quotations', '/my-quotations'], ['My Receipts', '/my-receipts'], ['My Payments', '/my-payments'], ['My Sales Order', '/my-sales-order'], ['My Purchase', '/my-purchase'], ['My Journal', '/my-journal'], ['My Contra', '/my-contra'], ['My Purchase Order', '/my-purchase-order'], ['My Credit Note', '/my-credit-note'], ['My Debit Note', '/my-debit-note'], ['My Stock Journal', '/my-stock-journal'], ['My Physical Stock', '/my-physical-stock'], ['My Receipt Note', '/my-receipt-note'], ['My Delivery Note', '/my-delivery-note'], ['My eWay Bills', '/my-eway-bill'], ['My Invoices', '/my-invoices'], ['My Parties', '/my-parties'], ['My Stock Items', '/my-stock-items']],
}
