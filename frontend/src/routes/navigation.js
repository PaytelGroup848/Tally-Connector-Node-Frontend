...
export const submenuItems = {
  ...
  "My Entries": [
    ...
    ["My Sales Order", "/my-sales-order"],
    ["My Purchase", "/my-purchase"],
    ["My Journal", "/my-journal"],
    ["My Contra", "/my-contra"],
    ["My Purchase Order", "/my-purchase-order"],
    ["My Credit Note", "/my-credit-note"],
    ["My Debit Note", "/my-debit-note"],
    ["My Stock Journal", "/my-stock-journal"],
