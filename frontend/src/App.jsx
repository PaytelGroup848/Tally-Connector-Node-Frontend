...
function App() {
  ...
  const hasActiveSubscription = Boolean(
    ...
    String(subscriptionStatus).toLowerCase() === "paid" ||
    String(subscriptionStatus).toLowerCase() === "success",
  );
  ...
  useEffect(() => {
    ...
    if (currentPath === "/") {
      window.history.replaceState(
        {},
        "",
        hasActiveSubscription ? "/dashboard" : "/plans",
      );
  ...
  }, [isAuthenticated, isLoading, currentPath, hasActiveSubscription]);
