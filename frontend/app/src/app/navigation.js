export const navItems = [
  ...
  ['＋', 'Create Vouchers', true, false, 'create-voucher'],
  ['▥', 'Sales', true, false, 'sales'],
  ['♧', 'Purchase', true, false, 'purchase'],
  ['▤', 'Cash & Bank', true, false, 'cash-bank'],
  ['▣', 'Collect Payments', false, false, 'collect-payments'],
  ['▱', 'Parties', false, false, 'parties'],
  ['▤', 'Items', false, false, 'items'],
  ['▥', 'Reports', false, false, 'reports'],
  ['▧', 'My Entries', true, false, 'my-entries'],
  ['⚙', 'Configurations', false, false, 'configurations'],
  ['⌕', 'GST Search', false, 'NEW', 'gst-search'],
  ['⌂', 'Data Backup', false, false, 'data-backup'],
]
