...
function Sidebar({ collapsed, currentPath, showDashboard, expandedNav, setExpandedNav, onDashboard, onQuotation, onNavigate }) {
  ...
  return (
    <aside className={`app-sidebar fixed left-0 top-0 z-30 flex h-screen shrink-0 flex-col bg-neutral-900 text-white transition-[width] duration-200 ${collapsed ? 'w-[58px]' : 'w-[200px]'}`} data-collapsed={collapsed}>
